...
df = df.rename(columns={'StepTotal': 'Step Total'})
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.Div(
            "This dashboard is for physical therapists with 30 patients with health data spanning from April 12 to March 12 of 2016. It gives an overview of how various health attributes affect the others, and of the patterns amongst and within users as well. This can also be used by public health organizations to monitor population-level trends, develop targeted interventions, and advocate for policies that support healthier lifestyles.",
...
def scatter_plot(selected_month, uncolored_dots, n_clicks, trendline_on):
    ...
    if n_clicks % 2 == 0:
        x_axis, y_axis = 'Step Total', 'Calories'
    else:
        x_axis, y_axis = 'Calories', 'Step Total'
    ...
    # Update x-axis label
    #scatter_fig.update_xaxes(title_text="StepTotal")
